...
configurationMetadata = cms.untracked.PSet(
        ...
        name = cms.untracked.string('$Generic BBbar with a long-lived scalar resonance, m=2 GeV, ctau=1 mm$'),
        annotation = cms.untracked.string('Generic BBbar with a long-lived scalar resonance, m=2 GeV, ctau=1 mm')
)
...
generator = cms.EDFilter("Pythia8GeneratorFilter",
    PythiaParameters = cms.PSet(
            ...
            processParameters = cms.vstring(
                    ...
                    '6000211:all = GeneralResonance void 0 0 0 2.0 0.001 0.0 0.0 1',
