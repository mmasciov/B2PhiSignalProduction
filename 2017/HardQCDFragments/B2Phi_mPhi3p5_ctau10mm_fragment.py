...
configurationMetadata = cms.untracked.PSet(
        ...
        name = cms.untracked.string('$Generic BBbar with a long-lived scalar resonance, m=3.5 GeV, ctau=10 mm$'),
        annotation = cms.untracked.string('Generic BBbar with a long-lived scalar resonance, m=3.5 GeV, ctau=10 mm')
)
...
generator = cms.EDFilter("Pythia8GeneratorFilter",
    PythiaParameters = cms.PSet(
            ...
            processParameters = cms.vstring(
                    ...
                    '6000211:all = GeneralResonance void 0 0 0 3.5 0.001 0.0 0.0 10',
